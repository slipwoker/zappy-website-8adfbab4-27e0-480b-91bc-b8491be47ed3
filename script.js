    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אילנית שייט שרון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8adfbab4-27e0-480b-91bc-b8491be47ed3',
                    name: data.name || '',
                    email: data.email || '',
